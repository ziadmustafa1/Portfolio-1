...
import { Github, Linkedin, Mail, MessageSquare, Send, ExternalLink, CheckCircle } from "lucide-react";
...
export function Contact() {
  ...
  return (
    <section id="contact" className="w-full py-20 md:py-28 lg:py-36 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        {mounted && contactParticles.map((particle, i) => (
          <motion.div
            key={i}
