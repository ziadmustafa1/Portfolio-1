...
const SkillCategory = ({ category, skills, index }: { category: string, skills: Skill[], index: number }) => {
      ...
      <Card className="p-6 shadow-lg backdrop-blur-sm bg-white/90 dark:bg-slate-900/90 border border-slate-200/50 dark:border-slate-700/50 overflow-hidden relative">
        ...
        <div className="space-y-5 relative z-10">
          <div className="flex items-center gap-3 border-b pb-3 border-slate-200 dark:border-slate-700">
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">{category}</h3>
            ...
            {skills.map((skill, idx) => (
              ...
              >
                <div className="flex justify-between text-sm font-medium items-center">
                  ...
                  <span className="font-bold text-slate-800 dark:text-slate-200">{skill.level}%</span>
                </div>
