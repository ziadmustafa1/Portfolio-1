...
const skillCategories = [
  {
    ...
    description:
      'Building responsive, interactive, and high-performance user interfaces using modern JavaScript frameworks and libraries.',
    icon: 'Code',
    skills: [
  ...
  },
  {
    ...
    description:
      'Transforming design mockups into pixel-perfect interfaces with smooth animations and micro-interactions.',
    icon: 'Layers',
    skills: [
  ...
  },
  {
    ...
    description:
      'Enhancing application speed and efficiency through code optimization, lazy loading, and modern web techniques.',
    icon: 'Zap',
    skills: [
  ...
  },
  {
    ...
    description:
      'Implementing efficient state management solutions for complex applications with various data requirements.',
    icon: 'Cpu',
    skills: [
      { name: 'Redux', level: 'Advanced' },
  ...
  },
  {
    ...
    description:
      'Connecting front-end applications with back-end services and third-party APIs for data exchange.',
    icon: 'Database',
    skills: [
  ...
  },
  {
    title: 'Project Types',
    description:
      'Experience with various types of web applications and platforms across different industries.',
    icon: 'Globe',
    skills: [
    ...
    >
      <Card className="overflow-hidden h-full shadow-lg dark:shadow-slate-800/30 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
        <CardContent className="p-6">
          ...
          <p className="text-slate-700 dark:text-slate-300 text-sm mb-6">{category.description}</p>
...
const SpaceBackground = dynamic(
  () => import('./space-background').then((mod) => mod.SpaceBackground),
  {
    ssr: false,
    loading: () => null,
  },
