...
export function About() {
  const timelineItems = [
    {
      ...
      description:
        'Began career as a freelance developer working with startups and small businesses',
  ...
  const traits = [
    {
      text: 'Pixel-perfect Figma to code',
  ...
  return (
    <section
      id="about"
      className="w-full py-20 mx-auto md:py-28 lg:py-36 bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
            ...
            <motion.div variants={itemVariants} className="relative">
              ...
              <div className="relative bg-white/80 dark:bg-slate-800/80 p-6 sm:p-8 rounded-xl backdrop-blur-sm shadow-xl border border-slate-200/50 dark:border-slate-700/50">
                <p className="text-lg text-slate-700 dark:text-slate-200 leading-relaxed">
                  I&apos;m a passionate Front-End and Full Stack Developer with a keen eye for
                  pixel-perfect design implementation. I specialize in transforming complex Figma
                  designs into high-performance web applications using modern JavaScript frameworks
                  and libraries. My approach focuses on creating fast, responsive, and visually
                  stunning interfaces that provide exceptional user experiences.
                </p>
              </div>
            </motion.div>
          ...
          {/* Timeline */}
          <motion.div variants={itemVariants} className="w-full max-w-4xl pt-8 relative">
              ...
              {timelineItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="md:w-1/2 md:pl-16">
                    {index % 2 !== 0 && <div className="hidden md:block h-full" />}
                  </div>
                </motion.div>
              ))}
            </div>
