...
const personSchema = {
  ...
  knowsLanguage: ['en', 'ar'],
  knowsAbout: ['Front-End Development', 'React.js', 'Next.js', 'TypeScript', 'Web Development'],
};
...
export const defaultMetadata: Metadata = {
  ...
  description:
    'Professional portfolio of Ziad Mostafa, a passionate Front-End and Full Stack Developer specializing in React, Next.js, and modern web technologies. مطور واجهات امامية متخصص في تطوير المواقع والتطبيقات',
  keywords,
  ...
  twitter: {
    ...
    title: 'Ziad Mostafa | Front-End & Full Stack Developer',
    description:
      'Front-End & Full Stack Developer specializing in React and Next.js | مطور واجهات امامية',
